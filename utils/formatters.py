...
def format_job_response(jobs: List[Dict], recommendations: Optional[List[Dict]], job_title:str) -> str:
    """
    ...
    if recommendations:
        ...
        message += "No portfolio project recommendations available at this time. But here are the positions:\n\n"
